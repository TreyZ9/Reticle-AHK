...
Loop, %CrosshairDisplay%
{
	If (CrosshairDisplay == A_Index)
	{
		CrosshairDisplayX += (Mon%A_Index%Right-Mon%A_Index%Left)//2-(diam//2)+CrosshairOffsetX
		CrosshairDisplayY := Mon%A_Index%Bottom//2-(diam//2)+CrosshairOffsetY
	}
	Else
	{
		CrosshairDisplayX += (Mon%A_Index%Right-Mon%A_Index%Left)
	}
}

Gui crosshair:show, % "x" CrosshairDisplayX " y" CrosshairDisplayY NA
; ------ Alteration End ------
